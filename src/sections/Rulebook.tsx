...
const Rulebook = () => (
    <section id="rulebook" className="mx-auto max-w-6xl scroll-mt-24 px-6 py-20">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.6fr_1fr]">
            ...
            >
                <div className="grid h-28 w-28 place-items-center rounded-full bg-dice/10 ring-2 ring-dice/30">
                    <Meeple className="h-16 w-16" color="#C24B4B" title="Simone meeple" />
                </div>
