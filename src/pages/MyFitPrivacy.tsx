            ...
            <div className={"myfit-body"}>
                <div className={"max-w-4xl mx-auto sm:px-16 px-8 py-16"}>
                    <div className={"myfit-card prose-myfit"}>
                        <p>
                            This privacy policy applies to the MyFit app for mobile devices,
                        ...
                        <p>
                            ...
                            rights. To exercise your CCPA/CPRA rights, contact the Service
                            Provider at{" "}
                            <a href={"mailto:baptistesimone19@gmail.com"}>
                                baptistesimone19@gmail.com
                            </a>
                        ...
                        <p>
                            ...
                            information, including but not limited to age, gender, weight. The
                        ...
                        <p>
                            ...
                            personal data to countries outside your country of residence,
                            including outside the European Economic Area (EEA). Where applicable
                            law requires safeguards for international transfers, the Service
                        ...
                        <p>
                            ...
                            appropriate safeguards and obtain any consent required for the
                            transfer.
                        </p>
                        <p>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                not have an independent use of the information the Service
                                Provider discloses to them, and have agreed to adhere to the rules
                        ...
                        <p>
                            ...
                            by uninstalling the Application. Uninstalling will stop the
                            Application from collecting data from your device, but it does not
                            automatically delete information that has already been transmitted to
                        ...
                        <ul>
                            <li>
                                <strong>User Provided Data:</strong> Retained for the duration of
                                your use of the Application plus 12 months thereafter, unless
                                longer retention is required by law
                            </li>
                            <li>
                                <strong>Automatically Collected Data:</strong> Retained for up to
                                24 months from collection, unless longer retention is required for
                                legal compliance
                            </li>
                            <li>
                                <strong>Aggregated and Anonymized Data:</strong> Retained
                                indefinitely as it no longer identifies you
                            </li>
                            <li>
                                <strong>Data required for legal compliance:</strong> Retained as
                                long as required by applicable law
                            </li>
                        </ul>
                        <p>
                            You may request deletion of your personal data, subject to any legal
                            obligation to retain it. If you want the Service Provider to delete
                            User Provided Data submitted through the Application, please contact
                            them at{" "}
                            <a href={"mailto:baptistesimone19@gmail.com"}>
                                baptistesimone19@gmail.com
                            </a>
                        ...
                        <p>
                            ...
                            or such higher age as required by applicable law. The Service Provider
                            does not knowingly solicit data from children or market the
                            Application to them.
                        </p>
                        <p>
                            Where parental or guardian consent is required under applicable law,
                            the Application is not intended for use without that consent. The
                            Service Provider does not knowingly collect personally identifiable
                            information from children under 16 years of age in violation of
                            applicable law. In the event the Service Provider discovers that a
                            child has provided personal information, the Service Provider will
                            immediately delete this from their servers. If you are a parent or
                            guardian and you are aware that your child has provided the Service
                            Provider with personal information, please contact the Service
                            Provider (
                            <a href={"mailto:baptistesimone19@gmail.com"}>
                                baptistesimone19@gmail.com
                            </a>
                        ...
                        <p>This privacy policy is effective as of 2026-06-09.</p>
                        ...
                        <p>
                            ...
                            before withdrawal. Processing based on other lawful bases is carried
