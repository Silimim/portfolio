            ...
            <div className={"myfit-hero"}>
                ...
                <div className={"max-w-4xl mx-auto sm:px-16 px-8 !pt-[126px] pb-16 relative z-10"}>
                    ...
                    <h1 className={"myfit-title mt-6"}>
                        Terms <span className={"myfit-gradient-text"}>of Use</span>
                    </h1>
                    <p className={"myfit-tagline mt-2"}>MyFit Android Application</p>
                    <p className={"text-white/60 text-sm mt-2"}>Effective date: June 9, 2026</p>
                </div>
            </div>
            ...
            <div className={"myfit-body"}>
                <div className={"max-w-4xl mx-auto sm:px-16 px-8 py-16"}>
                    <div className={"myfit-card prose-myfit"}>
                        <p>
                            These terms and conditions apply to the MyFit app for mobile devices,
                            together with any related services operated by Simone Baptiste
                            (collectively, the "Application"). Simone Baptiste is hereby referred
                            to as the "Service Provider".
                        </p>
                        <p>
                            By downloading or using the Application, you agree to these Terms and
                            Conditions. You should read them carefully before using the
                            Application.
                        </p>
                        ...
                        <p>
                            ...
                            license to install and use the Application on a mobile device for
                            ...
                            decompile, or disassemble the Application, except as and only to the
                        ...
                        <p>
                            ...
                            trademarks, logos, or branding for any purpose. You agree not to
                            remove, alter, or obscure any copyright, trademark, or other
                            proprietary notices displayed in or on the Application.
                        </p>

                        <h2>Termination</h2>
                        <p>
                            The Service Provider may suspend your access to the Application or
                            services if you materially breach these Terms. The Service Provider
                            will provide you with written notice of the breach and, where the
                            breach is capable of cure, you will have 14 days from receipt of
                            notice to remedy the breach. If you fail to cure the breach within
                            that period, the Service Provider may terminate your access.
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            16 years of age (the age of digital consent in your jurisdiction) to
                            use the Application. If you are below 16, a parent or legal guardian
                        ...
                        <p>
                            If this Application allows users to post, share, or upload content,
                        ...
                        <ul>
                            ...
                            <li>
                                Contains discrimination or incitement to violence or illegal
                                activity
                            </li>
                        ...
                        <ul>
                            ...
                            <li>
                                Suspend or terminate accounts of users who repeatedly violate
                                these guidelines
                            </li>
                            <li>
                        ...
                        <p>
                            ...
                            . The report should include enough information for the Service
                            Provider to identify the content, evaluate the complaint, and contact
                            you if follow-up is required.
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            to request further review. The Service Provider will respond to
                            appeals within a reasonable period and provide the reasons for any
                        ...
                        <p>
                            ...
                            business. This license does not grant the Service Provider the right
                            to sell or sublicense your content to third parties independently of
                            the Application. You represent and warrant that you own or control all
                        ...
                        <p>
                            ...
                            related to User-Generated Content is governed by the{" "}
                            <Link to={"/projects/myfit/privacy"}>Privacy Policy</Link>. Do not
                            post personal data of others without their consent.
                        </p>
                        <p>
                        ...
                        <p>
                            Nothing in these Terms shall limit any rights you have under
                            applicable consumer protection laws that cannot be lawfully excluded.
                        </p>
                        ...
                        <p>
                            ...
                            punitive damages, including but not limited to lost profits, data
                            loss, or business interruption, even if advised of the possibility of
                            such damages.
                        </p>
                        ...
                        <p>
                            ...
                            the claim, or the minimum amount that must be paid under applicable
                            law, whichever is greater. If the Application is provided free of
                            charge, this means the Service Provider's liability is limited to the
                        ...
                        <p>
                            ...
                            fees, arising out of or directly related to your breach of these Terms
                            or your intentional misuse of the Application, including
                        ...
                        <p>
                            ...
                            your device. You should accept updates when offered; if you choose
                            not to, the Service Provider may cease to support earlier versions
                            and the Application may not function properly. The Service Provider
                            may also wish to cease providing the application and may terminate
                            its use at any time without providing termination notice to you.
                            Unless they inform you otherwise, upon any termination, (a) the rights
                            and licenses granted to you in these terms will end; (b) you must
                            cease using the application, and (if necessary) delete it from your
                            device.
                        </p>
                        ...
                        <p>
                            ...
                            jurisdiction in which the Service Provider is established, excluding
                            conflict of law rules, except to the extent mandatory consumer
                        ...
                        <p>
                            <strong>Point of Contact:</strong> The Service Provider maintains a
                            single point of contact for direct communication with EU authorities
                            and recipients of the service, reachable at{" "}
                            <a href={"mailto:baptistesimone19@gmail.com"}>
                                baptistesimone19@gmail.com
                            </a>
                            . Where the Service Provider is established outside the European
                            Union, a legal representative in the EU has been designated in
                            accordance with Article 13 of the DSA.
                        </p>
                        <p>
                            <strong>Content Moderation and Statement of Reasons:</strong> When the
                            Service Provider restricts access to content, suspends or terminates
                            an account, or otherwise limits the availability of the Application's
                            features, a clear and specific statement of reasons will be provided
                            to the affected user. The statement will include the nature of the
                            restriction, the legal or contractual basis for the decision, and
                            information on available redress mechanisms, in accordance with
                            Article 17 of the DSA.
                        </p>
                        <p>
                            <strong>Notice and Action:</strong> Users and third parties may submit
                            notices of allegedly illegal content through the contact details
                            provided in these Terms. The Service Provider will process notices
                            promptly, diligently, and without automated decision-making where the
                            circumstances require human review. Notices will be acknowledged
                        ...
                        <p>
                            ...
                            content moderation decisions, including decisions to restrict content
                            or suspend accounts, may be submitted to an out-of-court dispute
                            settlement body certified in accordance with Article 21 of the DSA.
                        ...
                        <p>
                            <strong>Transparency Reporting:</strong> The Service Provider
                            publishes periodic transparency reports covering content moderation
                            activities, including the volume of notices received, actions taken,
                            and automated means used, in accordance with Article 24 of the DSA.
                        ...
                        <p>
                            ...
                            qualifies as an intermediary service under the DSA and does not
                            replace or limit any rights or obligations under applicable consumer
                            protection or data protection law.
                        </p>
                        ...
                        <p>
                            ...
                            <Link to={"/projects/myfit/privacy"}>Privacy Policy</Link>, constitute
                        ...
                        <p>These terms and conditions are effective as of 2026-06-09.</p>
                        ...
                        <p className={"text-white/50 text-sm"}>
                            This Terms &amp; Conditions page was generated by App Privacy Policy
                            Generator.
                        </p>
                    </div>
                    ...
                    <div className={"flex flex-wrap gap-3 mt-8"}>
                        ...
                        <Link to={"/projects/myfit/privacy"} className={"myfit-btn-ghost"}>
                            Privacy Policy
                        </Link>
                    </div>
                </div>
